...
| [`docs/development/windows-local-stack.md`](docs/development/windows-local-stack.md) | Windows demo stack: `run.ps1`, risk sizing, trade dashboard |
...
for services, the public TradingView webhook, risk sizing, and the Rey
